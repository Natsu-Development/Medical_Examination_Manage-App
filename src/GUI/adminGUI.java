...
public class adminGUI extends JFrame {
	...
	public void initComponent() {
		...
		JLabel lblNewLabel_1 = new JLabel("Chào GIÁM ĐỐC");
		...
		lblNewLabel_2.setBounds(656, 260, 300, 300);
		...
		btnHSBnh.setBounds(0, 621, 277, 64);
		contentPane.add(btnHSBnh);
